...
const About = () => {
  return (
    <main className="flex min-h[100%] flex-col items-center justify-between p-20 bg-white text">
      <h1 className="text-3xl p-2">О нас</h1>
      <p>
        Добро пожаловать в мир насыщенных вкусов и гастрономических
        удовольствий! Мы — команда страстных любителей бургеров, посвятившая
        себя созданию идеального бургерного опыта. Наша цель — привлечь вас в
